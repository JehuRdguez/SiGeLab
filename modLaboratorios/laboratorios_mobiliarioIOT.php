...
<div class="dropdown">
	...
	<div class="dropdown">
		...
		<a href="herramientas_laboratorioIOT/ReporteMobiliario_IOT.php" target="_blank" class="btn btn-outline-dark">Reporte PDF</a>

	</div>

	<div class="container">
		<br>
		<table class="table table-bordered " cellspacing="0" width="100%" id="laboratorios_mobiliarioTableIOT" style="background-color: #04aa89;  ">
			<thead>
				<tr>
			...
			<tbody>
				...
				$listaMobiliario = $mobiliarioR->readMobiliarioIOT(); //se crea la variable listaAdministradores
				?>
