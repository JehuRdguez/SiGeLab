...
<?php if ($_SESSION['idTipoUsuario'] == 1) { ?>
	...
	<div class="dropdown">
		...
		<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
			<li><a class="dropdown-item" href="../modLaboratorios/laboratorios_horariosIOT.php">Laboratorio de IoT</a></li>
			<li><a class="dropdown-item" href="../modLaboratorios/laboratorios_horariosDesarrollo.php">Laboratorio de desarrollo</a></li>
			<li><a class="dropdown-item" href="../modLaboratorios/laboratorios_horariosSoporte.php">Laboratorio de soporte</a></li>
		</ul>
	...
	<div class="dropdown">
		<button class="btn btn-outline-dark dropdown-toggle" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
			Horarios</button>
		<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
			<li><a class="dropdown-item" href="laboratoriosDesarrollo.php">Horarios</a></li>
			<li><a class="dropdown-item" href="laboratorios_equiposDesarrollo.php">Equipos</a></li>
			<li><a class="dropdown-item" href="laboratorios_perifericosMonitorDesarrollo.php">Periféricos</a></li>
			<li><a class="dropdown-item" href="laboratorios_mobiliarioDesarrollo.php">Mobiliario</a></li>
		</ul>
	...
	<div class="container">
		<br>
		<table class="table table-bordered " cellspacing="0" width="100%" id="laboratorios_horariosTableDesarrollo" style="background-color: #04aa89;">
			<thead>
				<tr>
					<th>Maestro</th>
					<th>Materia</th>
