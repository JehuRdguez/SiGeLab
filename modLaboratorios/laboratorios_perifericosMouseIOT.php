	...
	<div class="container-fluid" styles="position:relative; z-index: -1;">
		...
		<div class="dropdown">
			...
			<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
				<li><a class="dropdown-item" href="../modLaboratorios/laboratorios_perifericosMouseIOT.php">Laboratorio de IoT</a></li>
				<li><a class="dropdown-item" href="../modLaboratorios/laboratorios_perifericosMouseDesarrollo.php">Laboratorio de desarrollo</a></li>
				<li><a class="dropdown-item" href="../modLaboratorios/laboratorios_perifericosMouseSoporte.php">Laboratorio de soporte</a></li>
			</ul>
		...
		<div class="dropdown" id="div-inline">
			...
			<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
				...
				<li><a class="dropdown-item" href="../modLaboratorios/laboratorios_perifericosMouseIOT.php">Periféricos</a></li>
		...
		<div class="container">
			<br>
			<table class="table table-bordered " cellspacing="0" width="100%" id="laboratorios_perifericosMouseIOT" style="background-color: #04aa89;  ">
				<thead>
					<tr>
					...
					?>
						<tr>
							...
							<td>
								<?php
								if ($estado == 1) { ?>
									<a type="button" class="btn btn-outline-dark" href="herramientas_laboratorioIOT/updateMouseIOT.php?idPerifericos=<?php echo $idPerifericos; ?>"><i class="fa fa-eye-slash"></i></a>

								<?php } else { ?>
									<a type="button" class="btn btn-outline-dark" href="herramientas_laboratorioIOT/updateMouseIOT.php?idPerifericos=<?php echo $idPerifericos; ?>"><i class="fa fa-eye"></i></a>
								<?php } ?>
						...
						<div class="modal fade" id="editarMouse<?php echo $idPerifericos; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<form method="POST" action="herramientas_laboratorioIOT/editarMouseIOT.php">
