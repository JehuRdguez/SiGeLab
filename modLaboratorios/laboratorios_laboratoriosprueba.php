...
<?php if ($idTipoUsuario == 1) { ?>
	...
	<br>
    <a class="btn btn-outline-dark" href="laboratorios_prueba.php"><i class="fa-solid fa-person-walking-arrow-loop-left"></i></a>
    <a class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#laboratorio">Registrar</a>
	<br>

	<br />
	<div class="container">
		<table class="table table-bordered" id="laboratorios_laboratoriosTable" style="background-color: #04aa89;  ">
			<thead>
				<tr>
