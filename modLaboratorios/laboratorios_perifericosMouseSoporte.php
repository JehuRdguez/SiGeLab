	...
	<div class="container-fluid" styles="position:relative; z-index: -1;">
		...
		<div class="dropdown" id="div-inline">
			...
			<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
				...
				<li><a class="dropdown-item" href="../modLaboratorios/laboratorios_perifericosMouseSoporte.php">Periféricos</a></li>
		...
		<div class="container">
			<br>
			<table class="table table-bordered " cellspacing="0" width="100%" id="laboratorios_perifericosMouseSoporte" style="background-color: #04aa89;  ">
				<thead>
					<tr>
