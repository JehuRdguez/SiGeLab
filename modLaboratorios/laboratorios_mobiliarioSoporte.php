...
<div class="dropdown">
	...
	<div class="container">
		<br>
		<table class="table table-bordered " cellspacing="0" width="100%" id="laboratorios_mobiliarioTableSoporte" style="background-color: #04aa89;  ">
			<thead>
				<tr>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td>
							<?php if ($estado == 1) { ?>
								<a type="button" class="btn btn-outline-dark" href="herramientas_laboratorioSoporte/updateMobSoporte.php?idMobiliario=<?php echo $idMobiliario; ?>"><i class="fa fa-eye-slash"></i></a>

							<?php } else { ?>
								<a type="button" class="btn btn-outline-dark" href="herramientas_laboratorioSoporte/updateMobSoporte.php?idMobiliario=<?php echo $idMobiliario; ?>"><i class="fa fa-eye"></i></a>
							<?php } ?>
					...
					<div class="modal fade" id="editarMobiliario<?php echo $idMobiliario; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form method="POST" action="herramientas_laboratorioSoporte/editarMobiliarioSoporte.php">
