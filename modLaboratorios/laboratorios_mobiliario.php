	...
	<div class="container">
		...
		<table class="table table-bordered " cellspacing="0" width="100%" id="laboratorios_mobiliarioTable" style="background-color: #04aa89;  ">
			...
			<tbody>
				...
				$listaMobiliario = $mobiliarioR->readMobiliario(); //se crea la variable listaAdministradores
				?>
									...
									<div class="modal-body">
										...
										<div class="form-group">
											...
											<select class="form-select" aria-label="Default select example" id="idLaboratorio" name="idLaboratorio">
												...
												?>
												<option selected hidden value="<?php echo $datos_Mobiliario->idLaboratorio; ?>"><?php echo $nombreLaboratorio; ?></option>
												<?php
												$lista_Mobiliario = $mobiliarioR->readLabAct('idLaboratorio');
												while ($row = mysqli_fetch_object($lista_Mobiliario)) {
								...
								<center>
									...
									<div class="col-sm-10">
										...
										<select class="form-select" aria-label="Default select example" id="idLaboratorio" name="idLaboratorio">
											...
											<?php
											$listaMobiliario = $mobiliarioR->readLabAct('idLaboratorio');
											while ($row = mysqli_fetch_object($listaMobiliario)) {
												$idLaboratorio = $row->idLaboratorio;
												$nombreLaboratorio = $row->nombreLaboratorio; ?>
												<option value="<?php echo $idLaboratorio ?>"><?php echo $nombreLaboratorio ?></option>
											<?php } ?>
