...
<?php if ($_SESSION['idTipoUsuario'] == 1) { ?>
	...
	<div class="dropdown">
		<button class="btn btn-outline-dark dropdown-toggle" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
			Horarios</button>
		<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
			<li><a class="dropdown-item" href="laboratoriosSoporte.php">Horarios</a></li>
			<li><a class="dropdown-item" href="laboratorios_equiposSoporte.php">Equipos</a></li>
			<li><a class="dropdown-item" href="laboratorios_perifericosMonitorSoporte.php">Periféricos</a></li>
			<li><a class="dropdown-item" href="laboratorios_mobiliarioSoporte.php">Mobiliario</a></li>
		</ul>
					...
					<div class="modal fade" id="editarHorarios<?php echo $idHorarios; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form method="POST" action="herramientas_laboratorioSoporte/editarHorariosSoporte.php">
