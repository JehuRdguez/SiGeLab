...
<?php if ($idTipoUsuario == 1) { ?>
  ...
  <div class="container">
    <br>
    <table class="table table-bordered " cellspacing="0" width="100%" id="laboratorios_equiposTableIOT" style="background-color: #04aa89;  ">
      <thead>
        <tr>
      ...
      <tbody>
        ...
        $listaEquipos = $equiposR->readEquipoIOT(); //se crea la variable listaAdministradores
        ?>
