...
<?php if ($idTipoUsuario == 1) { ?>
  ...
  <div class="container">
    <br>
    <table class="table table-bordered " cellspacing="0" width="100%" id="laboratorios_equiposTableSoporte" style="background-color: #04aa89;  ">
      <thead>
        <tr>
      ...
      <tbody>
        ...
        $listaEquipos = $equiposR->readEquipoSoporte(); //se crea la variable listaAdministradores
        ?>
          ...
          <tr>
            ...
            <td>
              <center>
                <?php
                if ($estado == 1) { ?>
                  <abbr title="Deshabilitar"><a type="button" class="btn btn-outline-dark" href="herramientas_laboratorioSoporte/updateEquipoSoporte.php?idEquipo=<?php echo $idEquipo; ?>"><i class="fa fa-eye-slash"></i></a></abbr>
                <?php } else { ?>
                  <abbr title="Habilitar"><a type="button" class="btn btn-outline-dark" href="herramientas_laboratorioSoporte/updateEquipoSoporte.php?idEquipo=<?php echo $idEquipo; ?>"><i class="fa fa-eye"></i></a></abbr>
                <?php } ?>
          ...
          <div class="modal fade" id="editarEquipos<?php echo $idEquipo; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form method="POST" action="herramientas_laboratorioSoporte/editarEquipoSoporte.php">
