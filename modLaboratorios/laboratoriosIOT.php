...
<abbr title="Detalles"><a class="btn btn-outline-dark" href="../modLaboratorios/laboratorios_horariosIOT.php"><i class="fa-solid fa-list"></i></a></abbr>
<br>
			...
			?>
				<tr>
					...
					<td><center><a onclick="openModelPDF('<?php echo $url ?>')" type="button" class="btn btn-outline-dark" title="Ver PDF"><i class="fa-solid fa-magnifying-glass-plus"></i></a>
						<abbr title="Borrar"><a class="btn btn-outline-dark" onclick="return eliminar()" href="herramientas_laboratorioIOT/eliminarPDFIOT.php?idHorariospdf=<?php echo $idHorariospdf ?>"><i class="fa-solid fa-trash-can"></i></a></abbr></center>
					</td>
					</td>
				</tr>
			<?php
