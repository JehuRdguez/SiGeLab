...
<?php if ($idTipoUsuario == 1) { ?>
	...
	<div class="dropdown">
		...
		<abbr title="Detalles de horarios"><a class="btn btn-outline-dark" href="../modLaboratorios/laboratorios_horariosDesarrollo.php"><i class="fa-solid fa-list"></i></a></abbr>
	</div>
