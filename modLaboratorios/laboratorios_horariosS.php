...
<div class="dropdown">
	...
	<div class="btn-group" role="group" aria-label="Basic radio toggle button group">
		...
		<a class="btn btn-outline-dark" href="laboratoriosS.php" for="btnradio1">Horarios</a>

		<input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off">
		<a class="btn btn-outline-dark" href="laboratorios_equiposS.php" for="btnradio3">Equipos</a>

		<input type="radio" class="btn-check" name="btnradio" id="btnradio5" autocomplete="off">
		<a class="btn btn-outline-dark" href="laboratorios_perifericosS.php" for="btnradio5">Periféricos</a>

		<input type="radio" class="btn-check" name="btnradio" id="btnradio4" autocomplete="off">
		<a class="btn btn-outline-dark" href="laboratorios_mobiliarioS.php" for="btnradio4">Mobiliario</a>
	</div>


	<br>
	<br /> <a class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#horario">Registrar</a>
	<abbr title="Regresar"><a class="btn btn-outline-dark" href="../modLaboratorios/laboratoriosS.php"><i class="fa-solid fa-person-walking-arrow-loop-left"></i></a></abbr>
	<br>
