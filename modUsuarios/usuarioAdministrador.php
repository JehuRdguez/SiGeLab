                  ...
                  <form method="POST" action="EditarAdministrador.php">
                    ...
                    <div class="modal-body" id="cont_modal">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="numConAdmin" id="numConAdmin" class="form-control" value="<?php echo $numConAdmin; ?>" min="1" onkeypress="return verificaNumeros(event);" maxlength="8" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required> <!-- Devuelve una cadena vacia si no se cumple con ser mayor a 0-->
                      </div>


                      <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Nombre completo:</label>
                        <input type="text" name="nombreC" id="nombreC" class="form-control" onkeypress="return ValidarLestrasC(event)" value="<?php echo $nombreC; ?>" required="true">
                      </div>


                      <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Dirección de correo electrónico:</label>
                        <input type="email" name="correo" id="correo" class="form-control" value="<?php echo $correo; ?>" required="true">
                      </div>
                    ...
                    ?>
                        ...
                        <input type="text" name="contrasena" id="contrasena" class="form-control" onkeypress="return ValidarContrasena(event)" value="<?php echo $datos_admin->contrasena; ?>" required="true">
                      </div>
              ...
              <form method="post">
                <div class="row">
                  <center>
                    ...
                    <input type="text" name="nombreC" id="nombreC" class="form-control" onkeypress="return ValidarLestrasC(event)" required>
                    ...
                    <input type="text" name="contrasena" id="contrasena" class="form-control" onkeypress="return ValidarContrasena(event)" required>
                  </center>
                </div>
