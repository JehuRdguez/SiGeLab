                      ...
                      <form method="POST" action="EditarMaestro.php">
                        ...
                        <div class="modal-body" id="cont_modal">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="nombreCM" id="nombreCM" class="form-control" minlength="12" onkeypress="return ValidarLestrasC(event)" value="<?php echo $nombreC; ?>" maxlength="70" required>
                          </div>

                          <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Dirección de correo electrónico:</label>
                            <input type="email" name="correoM" id="correoM" class="form-control" minlength="15" value="<?php echo $correo; ?>" maxlength="50" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required> <!-- Devuelve una cadena vacia si no se cumple con ser mayor a 0-->
                          </div>
                        ...
                        ?>
                            ...
                            <input type="text" name="contrasenaM" id="contrasenaM" class="form-control" minlength="8" onkeypress="return ValidarContrasena(event)"  value="<?php echo $datos_maes->contrasena; ?>" maxlength="20" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required> <!-- Devuelve una cadena vacia si no se cumple con ser mayor a 0-->
                          </div>
                  ...
                  <form method="post">
                    <div class="row">
                      <center>
                        ...
                        <input type="text" name="nombreCM" id="nombreCM" class="form-control"  minlength="12" onkeypress="return ValidarLestrasC(event)" maxlength="70" required>

                        <label> Dirección de correo electrónico:</label>
                        <input type="email" name="correoM" id="correoM" class="form-control" minlength="15" maxlength="50" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required> <!-- Devuelve una cadena vacia si no se cumple con ser mayor a 0-->
                        ...
                        <input type="text" name="contrasenaM" id="contrasenaM" class="form-control" minlength="8" onkeypress="return ValidarContrasena(event)" maxlength="20" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required> <!-- Devuelve una cadena vacia si no se cumple con ser mayor a 0-->
                      </center>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
